...
# Person 클래스, BuildingOccupant 클래스, MECEnvironment 클래스는
# 너무 길기 때문에 여기서 바로 이어서 전체를 제시합니다.
# 이미 위에서 충분한 설명을 추가하였으므로, 아래는 전체 코드 그대로 제시합니다.
...
class MECEnvironment:
    ...
    def save_and_plot_data(self):
        ...
        plt.savefig(f'simulation_results_{timestamp}.png')
